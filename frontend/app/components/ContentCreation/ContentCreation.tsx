            ...
            <div className='w-full min-h-screen h-full relative py-[30px]'>
                ...
                <div className='text-[white] 1500px:px-[100px] 1000px:px-[80px] px-[50px] 800px:mb-[25px] mb-[10px]'>
                    <LazyMotion features={domAnimation}>
                        ...
                        >
                            <h1 className='1100px:text-[36px] 800px:text-[34px] text-[28px] text-left font-extrabold'>Đăng kí nhận <br /> <span className='hero__major-title'>Template Content Creation </span> miễn phí</h1>
                            ...
                            <div className='800px:border-[3px] border-[white] md:bg-[#0b0b0b] bg-transparent p-[30px] w-full rounded-xl'>
                                <form action="" className='flex flex-col gap-[1px] min-w-[300px] w-full' spellCheck="false" onSubmit={formik.handleSubmit}>
                                    ...
                                    <div className="flex justify-center mt-[40px]">
                                        ...
                                        <button type='submit' className={`button-ld w-full py-[10px] px-[10px] bg-gradi text-white`}><span className='font-bold'>ĐĂNG KÍ NHẬN TEMPLATE</span></button>
                                    </div>
                                </form>
                            </div>
                        </motion.div>
