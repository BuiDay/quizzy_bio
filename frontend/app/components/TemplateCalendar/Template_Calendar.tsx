            ...
            <div className='w-full min-h-screen h-full relative py-[30px]'>
                ...
                <div className='text-[White] 1500px:px-[100px] 1000px:px-[80px] px-[50px] 800px:mb-[25px] mb-[10px]'>
                    <LazyMotion features={domAnimation}>
                        ...
                        >
                            <h1 className='1100px:text-[36px] 800px:text-[34px] text-[28px] text-left font-extrabold'>Đăng kí nhận <br /> <span className='hero__major-title'>Template Content Calendar </span>miễn phí</h1>
                ...
                <div className='w-full h-full flex 800px:flex-row flex-col items-center justify-center 800px:justify-start 800px:pr-[50px] pr-0'>
                    <motion.div
