...
const ActionCTA = () => {
    ...
    return (
        <div className='w-full min-h-screen h-full bg-[#0b0b0b]'>
            ...
            <div className='text-[white] 1500px:px-[100px] 1000px:px-[80px] px-[40px] 800px:mb-[25px] mb-[10px]'>
                <LazyMotion features={domAnimation}>
                    <m.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                        transition={{ duration: 2, delay: 0.5 }}
                    >
                        <h1 className='1100px:text-[36px] 800px:text-[34px] text-[28px] text-left font-extrabold'>Đăng kí nhận <br /> <span className='hero__major-title'>CTA TEMPLATE </span> miễn phí</h1>
            ...
            <div className='w-full h-full flex 800px:flex-row flex-col items-center justify-center 800px:justify-start gap-[-20px] 800px:pr-[50px] pr-0'>
                <motion.div
                ...
                >
                    <div className='w-full max-w-[1100px] relative'>
                        ...
                        <div className=' relative z-20 w-full 800px:text-[16px] text-[14px] flex xl:flex-row flex-col gap-10 text-justify 1500px:px-[100px] 1000px:px-[80px] px-[50px] 800px:py-[30px] py-[20px] text-[white]'>
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                ...
                <div className='z-30'>
                    ...
                    >
                        <div className='800px:border-[3px] border-[white] md:bg-[#0b0b0b] bg-transparent p-[30px] w-full rounded-xl'>
